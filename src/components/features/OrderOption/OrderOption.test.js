...
describe('Component OrderOption', () => {
  ...
  it('should return the same value as in the prop name', () => {
...
for(let type in optionTypes){
  describe(`Component OrderOption with type=${type}`, () => {
    ...
    switch (type) {
      ...
      case 'number': {
        it('conatins div with number class and imput', () => {
        ...
        it('should run setOrderOption function o change', () => {
